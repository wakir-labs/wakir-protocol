...
from wakir_protocol.canonical.caveat_set import (
...
from _tv_w_2_pin_pack_builder import (
    APPEND_1_CAVEATS,
    AUTHORITY_CAVEATS,
    CONTEXT_AUDIENCE,
    CONTEXT_TIMES,
...
def test_a5_pin_pack_hash_under_pure_python_only(golden: dict) -> None:
    ...
    from _tv_w_2_pin_pack_builder import build_pin_pack_with_hash
