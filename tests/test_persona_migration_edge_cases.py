...
"""Self-migration converter edge-case test pack (S2-T1-03).

Coverage map (the design sketch §3.4 + this module auftrag)
========================================================
...
def test_caller_pin_bare_hex_form_drift_is_detected():
    ...
    from wakir_protocol.persona import PersonaMigrationDeterminismError
    bogus_bare = "0" * 64
...
def test_cycle_guard_fires_on_self_referencing_step(monkeypatch):
    ...
    from wakir_protocol.persona import persona_migration as mig
