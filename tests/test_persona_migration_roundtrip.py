...
"""Self-migration cross-version roundtrip test pack (S2-T1-04).
...
M-3 anchor (the design sketch §4.4): migration is **not** required to be
...
# ---------------------------------------------------------------
# A. v0 -> v1 single-step pin equivalence (re-anchor of this module)
# ---------------------------------------------------------------
