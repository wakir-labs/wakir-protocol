...
This module inventory: T-SR-SIG-01..12.
...
def test_t_sr_sig_02_signing_payload_deterministic() -> None:
    ...
    # And the envelope bytes are byte-equal too (this module invariant).
...
def test_t_sr_sig_07_backward_compat_unsigned_envelope() -> None:
    entry = _make_entry()
    blob = _entry_to_envelope(entry)  # this module codec output, no signature
...
# ---------------------------------------------------------------------------
# T-SR-SIG-12: This module codec parity — signed envelope differs from this module
