...
SCHEMA_PATH = WIRELANG_ROOT / "wakir_protocol" / "schemas" / "datalog-caveat.json"
...
def test_positive_example_caveat_set_file_validates(
    ...
    example_path = WIRELANG_ROOT / "wakir_protocol" / "examples" / "datalog-caveat-set-example.json"
