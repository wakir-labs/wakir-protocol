...
from wakir_protocol.identity_substrate.aip_document_transport_fetch import (
    DNS_ANCHOR_PREFIX,
...
from wakir_protocol.identity_substrate.dns_anchor import DnsAnchorError, TxtResolver
...
def test_T_AIP_FT_05_fetch_rejects_non_object_root_body() -> None:
    ...
    place.
    """
    from wakir_protocol.identity_substrate.aip_https_backend import HTTPSPayloadError
