...
from wakir_protocol.identity_substrate import _jcs_pure, _schema_pure
...
def _load_aip_schema() -> dict:
    ...
    schema_path = here.parent / "wakir_protocol" / "schemas" / "aip-document.json"
...
def test_aip_signing_works_with_pure_python_fallback_only(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    from wakir_protocol.identity_substrate import aip_signing
...
def test_jcs_pure_matches_ftd_verifier_local_jcs() -> None:
    from wakir_protocol.identity_substrate import ftd_verifier as fv
