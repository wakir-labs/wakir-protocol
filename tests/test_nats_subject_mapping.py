...
from wakir_protocol.wirelang import (
    SubjectV1,
    SubjectFormatError,
    build_subject,
    parse_subject,
...
from wakir_protocol.wirelang.nats_subject_mapping import SCHEMA_SUBJECT_REGEX


WIRELANG_ROOT = Path(__file__).resolve().parent.parent
SCHEMA_PATH = WIRELANG_ROOT / "wakir_protocol" / "schemas" / "layer-0-transport.json"
