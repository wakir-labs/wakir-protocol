...
- This module sketch §3 (V0->V1->V2 forward chain design).
- This module outbox §"Substanz-Bilanz" (V1ToV2Step + chain pins).
- This module box: "V0V1Step + V1V2Step Operator-CLI-Erweiterung —
...
``PERSONA_SCHEMA_VERSION_LIST``, which This module already extended to
...
from wakir_protocol.persona.cli import (
...
def test_build_parser_accepts_target_persona_v2():
    """argparse must accept ``--target persona-v2`` after this module.
