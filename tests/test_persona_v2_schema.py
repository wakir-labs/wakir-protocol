...
"""persona-v2 (V10) schema validation tests.
...
(this module sketch). These tests pin the field-spec at JSON-Schema
...
3. **Positive** — reserved-fields-present-but-empty validates (this module
...
This module implementation box adds the Cross-Version-Roundtrip
