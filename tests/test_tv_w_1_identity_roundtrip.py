...
"""TV-W-1 hermetic Identity Pin-Pack Roundtrip.
...
from wakir_protocol.identity_substrate import (
...
from wakir_protocol.identity_substrate.key_derivation import (
    ed25519_public_from_private,
    secp256k1_public_from_private,
)

from _tv_w_1_pin_pack_builder import (
    TV_W_1_PERSONA_GRID,
...
def test_a2_aip_signatures_verify_with_published_pubkey(golden: dict) -> None:
    ...
    """
    seed = bytes.fromhex(TV_W_1_TEST_SEED_HEX)
    from wakir_protocol.identity_substrate import generate_aip_document
...
# ---------------------------------------------------------------------------
# Cross-compat anchors (this module forward-compatibility)
# ---------------------------------------------------------------------------
...
This module Capability-Token-Pin issuer key (TV-W-2 input per spec §2.2).
...
This module AIP-Doc-Pin signing keypair (TV-W-3 input per spec §3.2).
