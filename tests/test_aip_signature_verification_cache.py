...
"""Hermetic tests for ``wakir_protocol.identity_substrate.aip_signature_verification_cache``.

This module. Tests cover the cache hit/miss accounting,
...
:func:`wakir_protocol.identity_substrate.verify_aip_signature`, and structural-failure
...
from wakir_protocol.identity_substrate.aip_signature_verification_cache import (
    DEFAULT_MAX_ENTRIES,
    DEFAULT_TTL_SECONDS,
    _build_cache_key,
...
def test_T_AIP_SVC_10_document_signature_stripped() -> None:
    ...
    This is the cache-key correctness probe for the ↔ this module
    byte-identity claim.
    """
    priv, pub = _keypair(_SEED_A)
    doc1 = _aip_doc(pub)
