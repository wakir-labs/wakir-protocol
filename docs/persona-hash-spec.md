...
### A.2 Frozen pin-pack (current state)
...
|---|---|---|
| `V8_PIN_HEX_RUST_ONLY` | the JCS-SHA-256 of the v8 canonical subset (no migration) — promoted from `None` in | `persona-canonical-form/src/lib.rs` |
