...
schema-registry-entry-signing layer (this module,
:mod:`wakir_protocol.schemas.entry_signing`). It binds a free-form ``kid``
...
1. **Lookup target:** the resolver iterates ``aip_doc["public_keys"]``
   ...
   §5.9 "this module byte-accuracy note".
...
This module boundary (spec §5.9 boundary block):
...
- Zone-1 cross-review consensus marker (2026-05-11).
"""
