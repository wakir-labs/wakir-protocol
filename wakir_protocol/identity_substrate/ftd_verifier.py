...
(``wakir_protocol.identity_substrate.dns_anchor``) with the FTD-doc schema check
...
5. Recompute SHA-256(JCS(body without document_signature)) and
   ...
   :class:`~wakir_protocol.identity_substrate.dns_anchor.TxtResolver`.
...
class FTDAnchorError(FTDVerifyError):
    ...
    Wraps :class:`~wakir_protocol.identity_substrate.dns_anchor.DnsAnchorError`
...
def verify_ftd_document(
    ...
    *,
    ...
    Args:
        ...
        resolver: a :class:`~wakir_protocol.identity_substrate.dns_anchor.TxtResolver`
