...
This module implementation (S2-T1-01).
...
- **A-1:** mock canonical subset is the input shape (this module baseline).
...
from wakir_protocol.persona.persona_canonical_form import (
...
from wakir_protocol.persona.persona_hash import (
...
#:
#: This module appends ``persona-v2`` as the converter's
...
#: lifts the engine-default-mock — neither has happened on this module, so a
...
def _coerce_to_dict(
    ...
    :mod:`wakir_protocol.persona.persona_canonical_form` (missing fence,
    ...
    *,
    ...
    Raises:
        PersonaMigrationError: when the chain cannot be resolved
            ...
            failures from
            :mod:`wakir_protocol.persona.persona_canonical_form` are
...
def _project_canonical_subset(fm_dict: dict[str, Any]) -> dict[str, Any]:
    ...
    :func:`wakir_protocol.persona.persona_canonical_form.extract_canonical_subset`,
