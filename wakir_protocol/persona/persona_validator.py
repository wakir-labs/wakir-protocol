...
side of :func:`wakir_protocol.persona.persona_canonical_form.read_canonical_subset`
plus :func:`wakir_protocol.persona.persona_canonical_form.extract_canonical_subset`,
...
- **No JSON-Schema validation.** The validator covers the seven
  ...
  :mod:`wakir_protocol.persona.persona_canonical_form`. Full JSON-Schema
...
from wakir_protocol.persona.persona_migration import PERSONA_SCHEMA_VERSION_LIST
