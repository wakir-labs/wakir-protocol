...
Scope: RealAdapter mirror, paired with the
SpiffeCrossTrustDomainBridge and the
...
This module Wirelang-Substrate adressierte NATS-KV-Backends
(this module capability-policy, this module multi-org-attestation,
This module federation-route-registry) ausschliesslich gegen ein
...
:mod:`wakir_protocol.adapters.real_spiffe_workload_api` mirror stub.
...
Das this module SpiffeCrossTrustDomainBridge-Pattern erwartet
...
gated (M-2 closeout marker). Dieser Adapter folgt der
