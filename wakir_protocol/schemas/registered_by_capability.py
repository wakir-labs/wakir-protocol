...
:class:`wakir_protocol.schemas.registry_nats_kv_backend.SchemaRegistryEntry`
...
1. **Layered above cryptographic verification.** The gate is *additive*
   policy on top of :func:`wakir_protocol.schemas.entry_signing.verify_entry_signature`.
   ...
   :mod:`wakir_protocol.schemas.entry_signing`; the gate is a *separate*
   authorisation layer.
...
3. **Glob semantics.** This module ships ``fnmatch`` glob matching for
...
This module and remain Phase-3 slots.
...
This module boundary (spec §5.12 boundary block):
...
- This module does NOT mutate
  :class:`wakir_protocol.schemas.registry_nats_kv_backend.NatsKvSchemaRegistry`;
...
- This module does NOT replace
  :func:`wakir_protocol.schemas.entry_signing.verify_entry_signature`; the
  signature-verification primitive remains caller-driven and
  byte-identical.

Cross-Review-Zone-1 (Identity-Substrate) interaction:

- Z-1-K-1 (kid-Resolver-Shape) is consumed *upstream* by the
  ...
  :func:`wakir_protocol.identity_substrate.kid_resolver.resolve_kid`.
- Z-1-K-2 (JCS-Resolver-Lock) is non-touched: the gate does
  not canonicalise anything; it is policy-evaluation only.
- Z-1-K-3 (Curve-Choice = Ed25519) is reinforced indirectly:
...
- Z-1-K-4 (STRICT-Mode-Activation-Owner) is non-touched:
  ...
  :class:`wakir_protocol.schemas.entry_signing.VerifyMode` toggle.
...
- :file:`wirelang/schemas/layer-3-capability-token.json` (the
  Wakir-Wirelang Layer-3 Biscuit v3 wrapper JSON schema; this module
...
from wakir_protocol.schemas.registry_nats_kv_backend import SchemaRegistryEntry
...
class RegisteredByCapabilityError(Exception):
    ...
    *policy outcome* (no policy for this issuer, kid not in the
    ...
    :class:`wakir_protocol.schemas.entry_signing.SchemaRegistrySignatureError`
...
# This module: explicit revocation surface.
...
# This module bundle. Revocation has *precedence* over disabled
...
# This module: revocation field validation.
...
This module: an unrevoked policy returns False
...
# This module: revocation has top precedence.
...
def gate_signed_entry(
    ...
    *,
    ...
    """Gate a :class:`wakir_protocol.schemas.entry_signing.SignedSchemaRegistryEntry`
    end-to-end.
    ...
    :func:`wakir_protocol.schemas.entry_signing.verify_entry_signature`
    ...
    from wakir_protocol.schemas.entry_signing import SignedSchemaRegistryEntry
